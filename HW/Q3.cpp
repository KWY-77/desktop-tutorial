...
/**
 * secret takes in three parameters, two integer and a boolean
 * if the first integer is bigger than the second integer or the boolean is true, it would return true
